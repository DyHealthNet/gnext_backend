from .views.gene_view import GeneTopSignals, GeneOverview, GeneAssociationDataView
from .views.variant_view import VariantMetricsView, VariantAnnotationView
from .views.overview_view import OverviewDataView, TopHitsView, ConfigView
...
urlpatterns = [
    ...
    path("overview_get_config/", ConfigView.as_view(), name="overview_get_config"),
    path("gene_get_top_signals/", GeneTopSignals.as_view(), name="gene_get_top_signals"),
    path("gene_get_info/", GeneOverview.as_view(), name="gene_get_info"),
    path("gene_get_locuszoom_data/", GeneAssociationDataView.as_view(), name = "gene_get_locuszoom_data"),
]
